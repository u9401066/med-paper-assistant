...
Codex and OpenClaw. Claude Code uses the matching skill under
...
3. Read the relevant source skill for the requested phase:
   - `.claude/skills/project-management/SKILL.md` for setup and output type.
   - `.claude/skills/literature-review/SKILL.md` for evidence discovery.
   - `.claude/skills/draft-writing/SKILL.md` for section drafting.
   - `.claude/skills/manuscript-review/SKILL.md` for structured review.
   - `.claude/skills/word-export/SKILL.md` for DOCX delivery.
   - `.claude/skills/auto-paper/SKILL.md` only for full autopilot runs.

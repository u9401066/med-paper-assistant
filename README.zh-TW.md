...
<p align="center">
  ...
  <i>3 個 MCP Server · ~107 個工具 · 26 個技能 · 14 個 Prompt 工作流 — 全在 VS Code 裡</i>
</p>
...
| 元件                                                               | 類型                 | 工具數 | 說明                                                      |
| ------------------------------------------------------------------ | -------------------- | ------ | --------------------------------------------------------- |
| **[mdpaper](#-mdpaper-mcp-工具)**                                  | 核心 MCP Server      | 57     | 論文寫作：專案、文獻、草稿、分析、驗證、匯出              |
...
flowchart LR
    ...
    subgraph MCP["MCP Server（~107 工具）"]
        mdpaper["mdpaper<br/>57 工具<br/>草稿 · 匯出 · 驗證"]
...
| -------------------------- | -------------------------------- |
| 固定模板、僵化流程         | 彈性、探索式方法                 |
| 搜尋/寫作/引用分開多個 App | 一站式：~107 個工具在 VS Code 裡 |
...
│   └── interfaces/mcp/            #   MCP Server，57 工具分 7 大類
│

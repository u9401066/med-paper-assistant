...
<p align="center">
  ...
  <i>3 個 MCP Server · ~104 個工具 · 26 個技能 · 14 個 Prompt 工作流 — 全在 VS Code 裡</i>
</p>
...
flowchart LR
    ...
    subgraph MCP["MCP Server（~104 工具）"]
        mdpaper["mdpaper<br/>54 工具<br/>草稿 · 匯出 · 驗證"]
...
| -------------------------- | -------------------------------- |
| 固定模板、僵化流程         | 彈性、探索式方法                 |
| 搜尋/寫作/引用分開多個 App | 一站式：~104 個工具在 VS Code 裡 |
...
│   └── interfaces/mcp/            #   MCP Server，54 工具分 7 大類
│
...
| 狀態 | 功能                        | 說明                                         |
| ---- | --------------------------- | -------------------------------------------- |
| ✅   | **3 個 MCP Server**         | mdpaper (54) + pubmed-search (37) + CGU (13) |

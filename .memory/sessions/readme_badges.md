...
2. **MCP Compatible** - Indicates Model Context Protocol compatibility
3. **License MIT** - Shows open source license
4. **PubMed Integration** - Highlights PubMed API integration

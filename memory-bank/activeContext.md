...
v0.7.11 release hardening 已完成並發布：segmented commits 已推送到 `origin/master`，annotated tag `v0.7.11` 已推送，PyPI publish 成功，GitHub Release 已手動補建並附上 sdist/wheel/VSIX。這版鎖定 Phase 8-11 code-enforced release gates、D1-D9 meta-learning audit provenance、DOCX/PDF export integrity、release workflow least-privilege/frozen installs/security gate、VSIX package smoke，以及 README/skills/docs 對齊。
...
| Packaging             | `medpaper-assistant-0.7.11.vsix`, wheel 656 KB, sdist 772 KB built locally with bundled templates; tag/GitHub Release/PyPI published |

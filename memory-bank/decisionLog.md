...
- annotated `v0.9.0` 指向 `4d1bec7`；`master` CI 成功。
- PyPI trusted publishing 成功；GitHub Release 已發布 VSIX、wheel、sdist 與 SHA-256 digests。
- VS Marketplace 因 configured identity 回報 `TF400813`；保留為外部 credential/authorization 事項，不降低已驗證 artifact 的品質判定。

# Project Closeout Concept: {{PROJECT_NAME}}

**Output Type**: {{PAPER_TYPE}}
**Created**: {{CREATED_DATE}}
**Sponsor / Programme**: {{TARGET_JOURNAL}}

> Report observed delivery separately from interpretation. Every status claim should
> point to a dated artifact, approved record, dataset, or independently verified source.
...
- **Final artifact inventory**: [Locations and owners]
- **Data retention / disposal**: [Policy and dates]
- **Open issues and handoff**: [Owner, deadline, acceptance condition]

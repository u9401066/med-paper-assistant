"""
PubMed Client - Wrapper for PubMed API interactions.

This module wraps the existing Entrez functionality and provides a clean
...
class PubMedClient:
    ...
    def download_pdf(self, pmid: str) -> Optional[bytes]:
        """
        ...
        """
        result = self._searcher.download_pdf(pmid)

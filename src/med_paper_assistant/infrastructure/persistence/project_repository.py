...
from med_paper_assistant.shared.constants import PROJECT_DIRECTORIES, PAPER_TYPES
...
class ProjectRepository:
    ...
    def create(self, project: Project) -> Project:
        ...
        if project.paper_type and project.paper_type not in PAPER_TYPES:
            raise InvalidPaperTypeError(
                f"Invalid paper type '{project.paper_type}'."
            )
    ...
    def get(self, slug: str) -> Project:
        ...
        if not config_path.exists():
            raise ProjectNotFoundError(
                f"Project '{slug}' has no configuration file."
            )
...
---
*Template for: """ + type_info.get("name", "Research Paper") + """*
"""
        return template

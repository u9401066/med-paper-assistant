        ...
        "original-research": {
            ...
            "constraints": [
                ...
                },
                {
                    ...
                    "description": "Minimum 20 references required for original research",
                    "params": {"min_references": 20},
                    "severity": "CRITICAL",
                    "hook_ref": "Phase2Gate",
                    "provenance": "base",
                },
        ...
        "case-report": {
            ...
            "constraints": [
                ...
                },
                {
                    ...
                    "category": ConstraintCategory.BOUNDARY,
                    "rule": "minimum_references",
                    "description": "Minimum 8 references required for case reports",
                    "params": {"min_references": 8},
                    "severity": "CRITICAL",
                    "hook_ref": "Phase2Gate",
                    "provenance": "base",
                },
        ...
        "systematic-review": {
            ...
            "constraints": [
                ...
                },
                {
                    ...
                    "category": ConstraintCategory.BOUNDARY,
                    "rule": "minimum_references",
                    "description": "Minimum 40 references required for systematic reviews",

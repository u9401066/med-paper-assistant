...
from ..value_objects.citation import CitationStyle
...
class CitationFormatter:
    ...
    def format_reference(
        self, reference: Reference, style: CitationStyle = CitationStyle.VANCOUVER, number: int = 1
    ) -> str:
    ...
    def format_reference_list(
        self, references: List[Reference], style: CitationStyle = CitationStyle.VANCOUVER
    ) -> str:
    ...
    def _format_vancouver(self, ref: Reference, number: int) -> str:
        ...
        return (
            ...
            f"({ref.issue}):{ref.pages}." + (f" doi:{ref.doi}" if ref.doi else "")
        )
    ...
    def _format_apa(self, ref: Reference, number: int) -> str:
        ...
        return (
            ...
            f"({ref.issue}), {ref.pages}." + (f" https://doi.org/{ref.doi}" if ref.doi else "")
        )
